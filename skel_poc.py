...
def _fit_skel_sequence(torch, model, motion, seed_fit, start_index=0, iterations=16, progress_cb=None, empirical_profile=None, acquisition_mode="monocular_depth_safe"):
    ...
    result={'version':'110.3.21.1-segment-gentle-anatomical-layers','retargeting_mode':'fullbody_segment_frame_reference_skel_skeleton_layer','scale':float(scale.cpu()),
...
def _skel_volumetric_anatomy_2010(joints, joint_names):
    """V110.3.21.1 · Generates volumetric anatomically-shaped bone and muscle meshes.
...
def _plot_skel_mesh_walker(mesh_seq):
    """V110.3.21.1 · visor de atlas anatómico REAL sobre SKEL. Sin fallback geométrico."""
    try:
        ...
        if not _atlas_status.get("ready"):
            st.warning("V110.3.21.1 · Atlas BodyParts3D real todavía no está instalado en esta instancia.")
        ...
        # V110.3.21.1 · visor anatómico incremental.
        ...
        Plotly.newPlot(gd,data,{{
          title:'V110.3.21.1 · Anatomical Atlas Mesh',
        ...
        st.caption(
            "V110.3.21.1 inicia una rama biomecánica basada en Rajagopal2016/OpenSim. "
        ...
        # V110.3.21.1: legacy BodyParts3D video controls must not crash the OpenSim branch.
        ...
        if not _atlas_status.get("ready"):
            ...
            st.caption("V110.3.21.1 · Render anatómico bajo demanda: sólo se carga la capa seleccionada para reducir memoria.")
    except Exception as exc:
...
def _load_mesh_sequence_npz_bytes_2012(raw):
    """V110.3.21.1 · Reabre un NPZ SKEL ya calculado sin volver a generar los 75 frames."""
    try:
...
def render_skel_poc_panel(motion, acquisition_mode="monocular_depth_safe", acquisition_label=None):
    ...
    st.caption("V110.3.21.1 · Carga el NPZ descargado de este registro para abrir directamente sus 75 frames SKEL. No repite fitting, retargeting ni generación de los 75 frames.")
